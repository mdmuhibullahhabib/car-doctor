    ...
    <nav className="bg-white font-sans">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center space-x-8">
          <Link href="/" clLinkssName="text-gray-600 hover:text-red-500 transition-colors duration-300">Home</Link>
          <Link href="about" className="text-gray-600 hover:text-red-500 transition-colors duration-300">About</Link>
          ...
          <Link href="my-bookings" className="text-gray-600 hover:text-red-500 transition-colors duration-300">Bookings</Link>
        </div>
